...
model.load_weights('data/trainedNN/train_17_18_DT_2023_12_11_01_49_38/best_weights-29.h5')

pascal_shape=640
df_test = pd.read_csv('data/trainedNN/train_17_18_DT_2023_12_11_01_49_38/test.csv',delimiter=';',converters={'bbox': literal_eval})
bboxes=[]
classes=[]
image_paths=[]
i=0
